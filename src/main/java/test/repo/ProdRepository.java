...
@Autowired
    public ProdRepository(JdbcTemplate jdbcTemplate) {this.jdbcTemplate = jdbcTemplate;}
    ...
    public boolean deleteProductById(Integer id){return  jdbcTemplate.update(Sql.SQL_DELETE_PRODUCT_BY_ID, id) > 0;}
